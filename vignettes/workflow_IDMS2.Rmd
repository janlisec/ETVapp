...
vignette: >
  %\VignetteIndexEntry{Isotope dilution mass spectrometry (IDMS) workflow}
...
ETV/ICP-MS by [Vanhaecke *et al.*](https://pubs.rsc.org/en/content/articlelanding/1997/ja/a604133g). Using IDMS corrects non-spectral 
...
without spike addition [JL: but below you extract the spike isotope?? VS: the spike isotope is part of the natural isotopic composition and enriched in the spike material]. The package provides a triplicate sample measurement for 
...
grey vertical lines mark the peak integration range. The baseline is drawn in blue.

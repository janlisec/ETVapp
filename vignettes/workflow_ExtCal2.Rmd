...
vignette: >
  %\VignetteIndexEntry{External calibration (ExtCal) workflow}
...
The smoothing function is directed by the parameter filter length *fl* which 
...
peak. By default, a linear fitting will be computed. 

However, the parameter *deg* 
...
accomplished similar to the calibration measurements.
...
```{r process_blanks, message=FALSE}

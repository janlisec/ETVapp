...
The ETV/ICP-MS raw data for the external calibration workflow is included in the 
*ETVapp* package. A file path is created by running:
...
smpl_pro <- process_data(data = smpl_imp, c1 = int_col, fl = 7, wf = "ExtCal")
...
Compute sample result based on calibration model with the following code. The 
